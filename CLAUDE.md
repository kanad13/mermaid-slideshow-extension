...
This extension presents Mermaid diagrams, images, and markdown content from markdown files as a focused, full-panel slideshow in a VS Code webview. Each piece of content gets its own slide with keyboard/mouse navigation and live updates on edit. Package name: `mermaid-slideshow`, command prefix: `mermaidSlideshow`.

- Single source file: `src/extension.js`
- No runtime dependencies - Mermaid and marked loaded via CDN in webview
- Three slide types: mermaid, image, markdown (each toggleable via settings)
...
- Marked CDN: `https://cdn.jsdelivr.net/npm/marked@15/lib/marked.esm.js`
- Two mermaid extraction syntaxes: backtick (```) and Azure DevOps (:::)
- Slide separator: horizontal rules (---) split markdown into sections
...
- Test file at `examples/test.md` with diverse Mermaid diagrams, images, and markdown slides
