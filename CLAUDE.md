# Mermaid Slides Preview — VS Code Extension
...
This extension extracts Mermaid diagrams from markdown files and displays them as a slideshow in a VS Code webview panel. It was built by transforming an existing markdown preview extension. The Mermaid extraction logic from the original codebase is the foundation — do not rewrite it without cause.
